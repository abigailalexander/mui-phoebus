...
import { ActionButton, Divider, DropDown, GroupBox, Label, TextEntry, TextRead } from "../components/widgets";
    ...
    return (
        <Box sx={{ position: "absolute", left: 0, top: 0, width: 1200, height: 700 }}>
            ...
            <GroupBox x={660} y={25} w={500} h={300} value={"Heater 1"}>
                ...
                <Divider x={0} y={23} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={48} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={73} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={98} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={123} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={148} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={173} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={198} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={223} w={460} h={1} ></Divider>
                ...
                <Divider x={0} y={248} w={460} h={1} ></Divider>
