...
export default function DCMCameraScreen() {
    return (
        <Box sx={{ position: "absolute", left: 0, top: 0, width: 1280, height: 430 }}>
            <GroupBox x={0} y={0} w={340} h={90} value={"Embedded"}>
                ...
                <TextEntry x={5} y={30} w={85} h={20} value={"0.100"}></TextEntry>
                <Led x={100} y={30} w={20} h={20} value={0}></Led>
                <TextEntry x={130} y={30} w={140} h={20} value={"0.100"}></TextEntry>
