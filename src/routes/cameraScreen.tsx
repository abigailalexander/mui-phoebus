...
import { ActionButton, Divider, DropDown } from "../components/widgets";
    ...
    return (
        <Box sx={{ position: "absolute", left: 0, top: 0, width: 1280, height: 800 }}>
            <GroupBox x={0} y={38} w={410} h={304} value={"CAMERA"}>
                ...
                <Divider x={2} y={22} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={47} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={72} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={97} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={122} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={147} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={172} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={197} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={222} w={373} h={1} ></Divider>
                ...
                <Divider x={2} y={247} w={373} h={1} ></Divider>
